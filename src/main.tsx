...
(async () => {
  let bool;
  try {
    bool = await invoke("get_env", { env: "DEVELOPMENT" });
  } catch (e) {
    bool = false;
  }
  ...
  Sentry.init({
    ...
    // Session Replay
    replaysSessionSampleRate: bool ? 1.0 : 0.1, // This sets the sample rate at 10%. You may want to change it to 100% while in development and then sample at a lower rate in production.
